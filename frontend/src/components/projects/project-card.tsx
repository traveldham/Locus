...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group flex w-full flex-col rounded-xl border p-5 transition hover:border-border-secondary-alt hover:shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-500",
