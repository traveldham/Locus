...
export function SidebarExpandedIcon() {
  return <AngleDoubleLeft className="size-4.5" aria-hidden="true" />;
}

export function ThreeDots() {
  return <MenuMeatballs1 className="size-4.5" aria-hidden="true" />;
}

export function CloseIcon() {
  return <Close className="size-4.5" aria-hidden="true" />;
}
